...
knitr::include_graphics("README-dasymetric-mapping.png")
```
...
knitr::include_graphics("README-equation.png")
```
...
knitr::include_graphics("README-c-sensitivity.png")
```
...
knitr::include_graphics("README-c-sensitivity-map.png")
```
...
The following map provides a visual comparison between the metrics that were calculated (viewable online at https://ecological-cities.github.io/home2park/articles/home2park.html).
