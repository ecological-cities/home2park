...
The following interactive map provides a visual comparison between the metrics for the provision of park area that were calculated in the '[Get started](articles/home2park.html)' vignette.
