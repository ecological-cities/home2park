...
_Song, X. P., Chong, K. Y., home2park: An R package to assess the spatial provision of urban parks (in prep)._
...
Parks are the other important component of the analysis. These may be downloaded and processed from OSM using this package. The following example dataset contains parks in Singapore with selected attributes related to recreation/leisure:
